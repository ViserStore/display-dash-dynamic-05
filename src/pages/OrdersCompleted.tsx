...
const OrdersCompleted = () => {
  const { 
    ...
    goToPreviousPage,
    goToPage
  } = usePaginatedTrades(10, 'COMPLETED');
  ...
  const getTradeStatusDisplay = (winLoss: string, profitLoss: number) => {
    switch (winLoss) {
      case 'win':
        return { text: 'WIN', color: 'text-emerald-500' };
      case 'lose':
        return { text: 'LOSE', color: 'text-rose-500' };
      default:
        return profitLoss >= 0 
          ? { text: 'WIN', color: 'text-emerald-500' }
          : { text: 'LOSE', color: 'text-rose-500' };
    }
  };
            ...
            <div className="p-[15px] relative z-[2] rounded-b-[30px]">
              <div className="_flex_lq8ol_19 _gap-3_lq8ol_180 _items-center_lq8ol_27 _justify-between_lq8ol_31">
                <div className="_flex_lq8ol_19 _gap-2_lq8ol_43 _items-center_lq8ol_27 bg-black/20 _border_lq8ol_234 border-gray-500/50 blackdrop-blur _rounded-full_lq8ol_119 px-[20px] h-[48px]">
                  ...
                  <h1 className="_text-white_lq8ol_196 _font-bold_lq8ol_110">Completed Orders ({totalCount})</h1>
                </div>
              ...
              <div className="_grid_lq8ol_157 gap-0 my-3">
                {completedTrades.length === 0 ? (
                  <div className="text-center text-white py-8">
                    <div className="text-gray-400">No completed trades</div>
                    <div className="text-sm text-gray-500 mt-2">Complete some trades to see results here</div>
                  </div>
                ) : (
                  completedTrades.map((trade) => {
                    const statusDisplay = getTradeStatusDisplay(trade.win_loss, trade.profit_loss);
                    ...
                    return (
                      <div key={trade.id} className="_border-b_lq8ol_596 border-b-slate-400/50 _py-2_lq8ol_422">
                        ...
                        <div className="_flex_lq8ol_19 _justify-between_lq8ol_31 _items-center_lq8ol_27">
                          <h1 className="_text-[14px]_lq8ol_407 _font-semibold_lq8ol_73 _text-gray-400_lq8ol_587">Close Price</h1>
                          <h1 className="_text-[14px]_lq8ol_407 _font-semibold_lq8ol_73 _text-white_lq8ol_196">
                            {trade.trade_close_price ? formatPrice(trade.trade_close_price) : (trade.close_price ? formatPrice(trade.close_price) : 'N/A')}
                          </h1>
                        </div>
                        <div className="_flex_lq8ol_19 _justify-between_lq8ol_31 _items-center_lq8ol_27">
                          <h1 className="_text-[14px]_lq8ol_407 _font-semibold_lq8ol_73 _text-gray-400_lq8ol_587">Closing Time</h1>
                          <h1 className="_text-[14px]_lq8ol_407 _font-semibold_lq8ol_73 _text-white_lq8ol_196">
                            {trade.closing_time ? formatDateTime(trade.closing_time) : formatDateTime(trade.updated_at)}
                          </h1>
                        </div>
                        <div className="_flex_lq8ol_19 _justify-between_lq8ol_31 _items-center_lq8ol_27">
                          <h1 className="_text-[14px]_lq8ol_407 _font-semibold_lq8ol_73 _text-gray-400_lq8ol_587">Result</h1>
                          <div className="_text-[14px]_lq8ol_407 _font-semibold_lq8ol_73 _text-white_lq8ol_196">
                            <h1 className={`text-[14px] rounded-[5px] ${statusDisplay.color}`}>
                              {statusDisplay.text} ≈ ${Math.abs(trade.profit_loss).toFixed(2)}
                            </h1>
                          </div>
                        </div>
                      </div>
