  ...
  const fetchDepositMethod = async () => {
    try {
      ...
      if (data) {
        ...
        setValue('deposit_address', data.deposit_address || '');
      ...
      toast.error('Failed to fetch deposit method');
    ...
    return (
      <AdminLayout>
        <div className="flex justify-center items-center h-64">
          <div className="text-rose-700">Loading deposit method...</div>
        </div>
      </AdminLayout>
    );
  }
          ...
          <div className="card w-[100%] bg-white shadow-xl">
            <div className="card-header px-3 py-2 border-b-2">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-rose-500 text-[20px] font-bold flex-auto">Update Deposit Method</h1>
                <Link 
...
export default AdminDepositMethodEdit;
