...
const AdminWithdrawMethodAdd = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      symbol: '$',
      user_info_label: 'Your Account Details'
    }
  });
  ...
  const onSubmit = async (data: WithdrawMethodForm) => {
    try {
      ...
      toast.error('Failed to add withdraw method');
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="card w-[100%] bg-white shadow-xl">
            <div className="card-header px-3 py-2 border-b-2">
              <div className="flex items-center gap-2">
                ...
                <h1 className="text-rose-500 text-[20px] font-bold flex-auto">Add Withdraw Method</h1>
                <Link 
...
export default AdminWithdrawMethodAdd;
