...
const AdminDepositLogs = () => {
  ...
  const fetchDeposits = async () => {
    try {
      ...
      toast.error('Failed to fetch deposit logs');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="mx-[8px] mt-2">
          <div className="flex items-center mb-3">
            <div className="flex-auto">
              <h1 className="font-bold text-[20px] text-rose-500">All Deposit Logs</h1>
              <h1 className="font-bold text-[14px] text-gray-400">Manage All Deposit Logs from Here ({totalCount} total)</h1>
            </div>
            <div>
              <select 
                value={statusFilter}
...
export default AdminDepositLogs;
