...
const AdminPendingWithdrawals = () => {
  ...
  const openAcceptModal = (withdrawal: Withdrawal) => {
    ...
    return (
      <AdminLayout>
        <div className="flex justify-center items-center h-64">
          <div className="text-rose-700">Loading pending withdrawals...</div>
        </div>
      </AdminLayout>
    );
  }
        ...
        <div className="mx-[8px] mt-2">
          <div className="flex items-center mb-3">
            <div className="flex-auto">
              <h1 className="font-bold text-[20px] text-rose-500">Pending Withdrawals</h1>
              <h1 className="font-bold text-[14px] text-gray-400">Manage Pending Withdrawal Requests</h1>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center rounded-lg text-white bg-rose-600 shadow-md shadow-rose-700/50 p-2 mb-3">
            <div className="flex-auto flex items-center">
              ...
              <h1 className="text-sm font-bold ps-2">Pending Withdrawals ({withdrawals.length})</h1>
            </div>
          </div>
